  ...
  <div class="header-container">
    ...
    <main class="design-wrapper" >
      <section class="design-container">
		<div id="wrap">
			<div class="headerh1">
				<h1>These are some of the Company Website designs that I made so far.</h1>
			</div>
			<div class="headerh1">
			...
			<div class="gallery">
				<a href="img/about.jpg" data-lightbox="roadtrip">
          <img id="small-top" class="small-img" src="img/about-small.jpg">
        </a>
				<a href="img/contact.jpg" data-lightbox="roadtrip">
          <img class="small-img" src="img/contact-small.jpg">
        </a>
				<a href="img/blog.jpg" data-lightbox="roadtrip">
          <img class="small-img" src="img/blog-small.jpg">
        </a>
				<a href="img/product.jpg" data-lightbox="roadtrip">
          <img class="small-img" src="img/product-small.jpg">
        </a>
				<a href="img/single-blog.jpg" data-lightbox="roadtrip">
          <img class="small-img" src="img/single-blog-small.jpg">
        </a>
			</div>
		</div>
      </section>
