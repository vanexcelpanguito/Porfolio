...
<body>
  <header class="main-header"> <!--section for header-->
    ...
    <main >
      <section class="main-banner"> <!--section for banner-->
        <div class="vertical-align">
          <h2>WELCOME TO MY WEBSITE</h2>
          <h1>Please feel free to look around.</h1>
        </div>
      </section>
  <div class="wrapper">
      <section class="link-section"> <!--section for links-->
        ...
        <a href="contact.php">
          <div style="margin-bottom: 16px;" class="bottom-links">
            <h3>Contact</h3>
          </div>
        </a>
      </section>
