...
<head>
  ...
  <style type="text/css" rel="stylesheet">
    *{
	...
	}@media only screen and (min-width: 765px){ /*start of media query for Portfolio. this section is for ipad*/
	.headerh1{
		width: 450px;
	}
	h1{
  ...
  <div class="header-container">
    ...
    <main class="design-wrapper" >
      <section class="design-container">
		<div id="wrap">
			<div class="headerh1">
				<h1>These are the designs I made for an Animal Clinic.</h1>
			</div>
			<div class="headerh1">
				<a class="back" href="portfolio.php">Go back to portfolio</a>
				<a class="back" href="design.php">Go back to "Design"</a>
			</div>
			<div class="gallery">
				<a href="img/vet-about.jpg"> <img id="small-top" class="small-img" src="img/vet-about-small.jpg"></img></a>
				<a href="img/vet-contact.jpg"><img class="small-img" src="img/vet-contact-small.jpg"></img></a>
				<a href="img/vet-order.jpg"><img class="small-img" src="img/vet-order-small.jpg"></img></a>
				<a href="img/vet-testimonials.jpg"><img class="small-img" src="img/vet-testimonials-small.jpg"></img></a>
				<a href="img/vet-faq.jpg"><img class="small-img" src="img/vet-faq-small.jpg"></img></a>
				<a href="img/vet-tnc.jpg"><img class="small-img" src="img/vet-tnc-small.jpg"></img></a>
			</div>
		</div>
      </section>
    </main>
