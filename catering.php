  ...
  <div class="header-container">
    ...
    <main class="design-wrapper" >
      <section class="design-container">
		<div id="wrap">
			<div class="headerh1">
				<h1>This is a website design that I made for a Catering company.</h1>
			</div>
			<div class="headerh1">
			...
			<div class="gallery">
				<a href="img/catering.png"> <img id="small-top" class="small-img" src="img/catering-small.jpg"></img></a>
			</div>
		</div>
      </section>
    </main>
